 ...
 * @author Thinuka
 */
public class BookCategoryAdd extends javax.swing.JDialog {
    ...
    public BookCategoryAdd(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BookCategoryAdd dialog = new BookCategoryAdd(new javax.swing.JFrame(), true);
